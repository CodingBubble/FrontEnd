...
class Group {
  ...
  Future<bool> admin_update(String new_name, String new_desc) async {
    ...
    var request = {
      "command": "group_update",
      "args": [username, password, id, new_name, new_desc]
    };
  ...
  Future<bool> admin_kick_user(User user_to_kick) async {
    ...
    var request = {
      "command": "group_kick",
      "args": [username, password, user_to_kick.id, id]
    };
    var url = Uri.http(api_settings.host, jsonEncode(request));
    var response = await http.get(url);
    var data = jsonDecode(response.body);
  ...
  Future<String?> admin_create_key({days_to_use: 7}) async {
    ...
    var request = {
      "command": "group_create_key",
      "args": [username, password, id, days_to_use]
    };
    var url = Uri.http(api_settings.host, jsonEncode(request));
    var response = await http.get(url);
    var data = jsonDecode(response.body);
  ...
  Future<List<User>> get_members() async {
    ...
    if (data["success"]) {
      List<User> users = [];
      data["result"].forEach((e) => {users.add(User(e["id"], e["username"]))});
      return users;
    }
    return [];
  }
  ...
  Future<List<GroupMessage>> get_messages_gen(int part) async {
    ...
    var request = {
      "command": "group_load_msgs_gen",
      "args": [username, password, id, part]
    };
    var url = Uri.http(api_settings.host, jsonEncode(request));
    var response = await http.get(url);
    var data = jsonDecode(response.body);
  ...
  Future<GroupMessage?> send_message(text, [benutzer]) async {
    if (me == null) {
      return null;
    }
    var request = {
      "command": "group_msg_send",
      "args": [username, password, id, text]
    };
    var url = Uri.http(api_settings.host, jsonEncode(request));
    var response = await http.get(url);
    var data = jsonDecode(response.body);
  ...
  Future<List<Event>> get_events_active() async {
    ...
    var request = {
      "command": "group_get_events_active",
      "args": [username, password, id]
    };
    var url = Uri.http(api_settings.host, jsonEncode(request));
    var response = await http.get(url);
    ...
    if (data["success"]) {
      List<Event> events = [];
      data["result"].forEach((e) => {
            events.add(Event(e["id"], this, e["creator"], e["eventname"],
                e["description"], DateTime.parse(e["date"])))
          });
      return events;
    }
    return [];
  ...
  Future<List<Event>> get_events_achieved() async {
    ...
    var request = {
      "command": "group_get_events_achieved",
      "args": [username, password, id]
    };
    var url = Uri.http(api_settings.host, jsonEncode(request));
    var response = await http.get(url);
    ...
    if (data["success"]) {
      List<Event> events = [];
      data["result"].forEach((e) => {
            events.add(Event(e["id"], this, me!.id, e["eventname"],
                e["description"], DateTime.parse(e["date"])))
          });
      return events;
    }
  ...
  Future<int> upload_image(File imageFile) async {
    ...
    var multipartFile =
        http.MultipartFile('image', stream, length, filename: "image");
  ...
  Future<Transaction?> create_transaction(
      String title, User from, User to, double balance) async {
    if (me == null) {
      return null;
    }
    var request = {
      "command": "transaction_create",
      "args": [username, password, from.id, to.id, balance, title, id]
    };
    var url = Uri.http(api_settings.host, jsonEncode(request));
    var response = await http.get(url);
    var data = jsonDecode(response.body);
  ...
  Future<List<Transaction>> get_transactions_of(User u) async {
    ...
    var request = {
      "command": "transactions_get_of_in",
      "args": [username, password, u.id, id]
    };
    var url = Uri.http(api_settings.host, jsonEncode(request));
    var response = await http.get(url);
    var data = jsonDecode(response.body);
  ...
  Future<List<Transaction>> get_transactions_between(User u1, User u2) async {
    ...
    var request = {
      "command": "transactions_get_between_in",
      "args": [username, password, u1.id, u2.id, id]
    };
    var url = Uri.http(api_settings.host, jsonEncode(request));
    var response = await http.get(url);
    var data = jsonDecode(response.body);
    if (data["success"]) {
      ...
      List o = order(u1, u2);
      data["result"].forEach((e) => {
            transactions.add(Transaction(e["id"], e["title"], o[0], o[1],
                double.parse(e["balance"].toString())))
          });
      return transactions;
    }
...
class Event {
  ...
  String description;
  DateTime time;
  Event(this.id, this.parental_group, this.creator_id, this.name,
  ...
  Future<List<Announcement>> get_announcements() async {
    ...
    var request = {
      "command": "event_load_announcements",
      "args": [username, password, id]
    };
    var url = Uri.http(api_settings.host, jsonEncode(request));
    var response = await http.get(url);
    ...
    if (data["success"]) {
      ...
      data["result"].forEach((e) => {
            messages.add(Announcement(
                e["id"], this, e["text"], DateTime.parse(e["date"])))
          });
      return messages;
    }
    return [];
  ...
  Future<List<Announcement>> get_announcements_gen(int part) async {
    ...
    var request = {
      "command": "event_load_announcements_gen",
      "args": [username, password, id, part]
    };
    var url = Uri.http(api_settings.host, jsonEncode(request));
    var response = await http.get(url);
  ...
  Future<Announcement?> creator_send_announcement(text) async {
    ...
    var request = {
      "command": "event_announcement_send",
      "args": [username, password, id, text]
    };
    var url = Uri.http(api_settings.host, jsonEncode(request));
    var response = await http.get(url);
  ...
  Future<bool> creator_update(
      String new_name, String new_desc, DateTime new_time) async {
    if (me == null) {
      return false;
    }
    var request = {
      ...
      "args": [
        ...
        new_name,
        new_desc,
        new_time.millisecondsSinceEpoch / 1000
      ]
    };
    var url = Uri.http(api_settings.host, jsonEncode(request));
    var response = await http.get(url);
  ...
  Future<List<Poll>> get_polls() async {
    ...
    if (data["success"]) {
      List<Poll> polls = [];
      data["result"]
          .forEach((e) => {polls.add(Poll(e["id"], e["title"], this))});
      return polls;
    }
    return [];
  }
  ...
  Future<ListItem?> creator_list_add_item(String title) async {
    ...
    if (data["success"]) {
      return ListItem(
          data["result"]["id"], title, this, data["result"]["user_bring"]);
    }
    return null;
  }
}
...
class Announcement {
  ...
  Future<bool> creator_delete() async {
    ...
    var request = {
      "command": "event_announcement_delete",
      "args": [username, password, id]
    };
    var url = Uri.http(api_settings.host, jsonEncode(request));
    var response = await http.get(url);
...
Future<List<Group>> me_get_groups() async {
  ...
  if (data["success"]) {
    ...
    data["result"].forEach((e) => {
          groups
              .add(Group(e["id"], e["admin"], e["groupname"], e["description"]))
        });
    return groups;
  }
  return [];
...
Future<Group?> me_use_invitation_code(String code) async {
  ...
  var request = {
    "command": "user_use_invitation_code",
  ...
  if (data["success"]) {
    ...
    return Group(data["result"]["id"], data["result"]["admin"],
        data["result"]["groupname"], data["result"]["description"]);
  }
  return null;
}
...
Future<bool> me_change_password(String newPassword) async {
  ...
  var request = {
    "command": "user_change_password",
    "args": [username, password, newPassword]
  };
  var url = Uri.http(api_settings.host, jsonEncode(request));
  var response = await http.get(url);
  var data = jsonDecode(response.body);
...
Future<Group?> me_create_group(String name, String desc) async {
  ...
  var request = {
    ...
    "args": [username, password, name, desc]
  };
  var url = Uri.http(api_settings.host, jsonEncode(request));
  var response = await http.get(url);
  var data = jsonDecode(response.body);
  if (data["success"]) {
    return Group(data["result"]["id"], data["result"]["admin"],
        data["result"]["description"], data["result"]["groupname"]);
  }
  return null;
}
...
Future<List<Event>> get_events_active_i_joined() async {
  ...
  var request = {
    "command": "user_get_all_active_joined_events",
    "args": [username, password]
  };
  var url = Uri.http(api_settings.host, jsonEncode(request));
  var response = await http.get(url);
...
Future<List<Transaction>> get_my_transactions_with(User l) async {
  ...
  var request = {
    "command": "transactions_get_between",
    "args": [username, password, l.id]
  };
  var url = Uri.http(api_settings.host, jsonEncode(request));
  var response = await http.get(url);
  var data = jsonDecode(response.body);
